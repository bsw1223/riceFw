...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="/member/find/pwd" method="post" onsubmit="return findpwdCheck()">
      ...
      <div class="row">        
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-flat">비밀번호재설정</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<script>			
		...
		function findpwdCheck() {			
			if(nameCheck() && id_result && emailCheck()) {
				return true;
			}
			else {
				return false;
