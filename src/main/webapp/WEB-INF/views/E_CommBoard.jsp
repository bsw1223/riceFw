...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#"><c:out value='${commName}' /></a></li>
		</ol>
	</section>
					...
					<div class="box-body">
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover" id="example2" class="table table-bordered table-hover">
								...
								<tbody>
									<c:forEach var="listB" items='${commboardlist}'>
										<tr>
											<td><c:out value='${listB.boNum}' /> </td>
											<td><a href="/comm/viewwritings/${pageMaker.cri.commURL}?boNum=<c:out value='${listB.boNum}'/>">
													<c:out value='${listB.boTitle}' />
											</a></td>
											<td><c:out value='${listB.memId}' /> 
											<td><c:out value='${listB.boViews}' /> 
											<td><c:out value='${listB.boLikes}' /> 
							...
							<ul class="pagination">
								...
								<c:if test='${pageMaker.prev}'>
									<li class="page-item"><a class="page-link"
										href="/comm/${pageMaker.cri.commURL}?page=${pnum}&amount=${pageMaker.cri.amount}page=${pageMaker.startPage-1}&amount=${pageMaker.cri.amount}">Previous</a></li>
								</c:if>
								...
								<a class="page-link"
												href="/comm/${pageMaker.cri.commURL}?page=${pnum }&amount=${ pageMaker.cri.amount}">${pnum}</a>
												</li>
								
											</c:forEach>
								<c:if test="${pageMaker.next}">
									<li class="page-item"><a class="page-link"
										href="/comm/${pageMaker.cri.commURL}?page=${pnum }&amount=${ pageMaker.cri.amount}">Next</a></li>
								</c:if>
							</ul>
						</div>
...
<form id="actionForm" action="/comm/${pageMaker.cri.commURL}" method='get'>
	<input type="hidden" name="page" value='${pageMaker.cri.page}'>
	<input type="hidden" name="amount" value='${pageMaker.cri.amount}'>
	<input type="hidden" name="commURL" value='${pageMaker.cri.commURL}'>
</form>
...
<script type="text/javascript">
	...
	function selChange() {
		...
		location.href = "/mypage/board/${pageMaker.cri.commURL}?page=" + page + "&amount=" + sel;
